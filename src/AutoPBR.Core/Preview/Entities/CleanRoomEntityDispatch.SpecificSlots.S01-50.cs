...
/// <summary>GPU specific-model dispatch slots 1–50.</summary>
    private static bool TryBuildSpecificDispatchSlots1Through50(
        ...
        out int specificRouteSlotHit)
    {
        ...
        if (TryBuildSpecificDispatchSlots1Through25(
                normalizedAssetPath,
                stem,
                texRef,
                profile,
        ...
        return TryBuildSpecificDispatchSlots26Through50(
            normalizedAssetPath,
            stem,
            texRef,
            profile,
