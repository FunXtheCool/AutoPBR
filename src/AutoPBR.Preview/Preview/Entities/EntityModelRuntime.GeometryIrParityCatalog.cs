...
internal sealed partial class EntityModelRuntime
{
    ...
    /// On failure, <see cref="EntityModelRuntime.TryBuildStaticMesh"/> surfaces an error placeholder mesh.
    /// </summary>
        ...
        out string? officialJvm)
    {
        ...
        mesh = EntityModelRuntime.ApplyParityCatalogPreviewPostProcess(
            mesh,
            rule,
            animationTimeSeconds);
        return true;
