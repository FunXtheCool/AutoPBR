...
public sealed class EntityCleanRoomAnimationMapTests
{
    private static string NativeData(string fileName) =>
        Path.Combine(AppContext.BaseDirectory, "Data", "minecraft-native", fileName);

    [Fact]
    public void CleanRoom_animation_map_covers_all_batch_animation_classes()
    {
        ...
        var bindings = EntityCleanRoomAnimationMap.GetBindings();
    ...
    [Fact]
    public void CleanRoom_animation_map_parity_builders_exist_in_entity_manifest()
    {
        ...
        foreach (var b in EntityCleanRoomAnimationMap.GetBindings())
        {
    ...
    [Fact]
    public void CleanRoom_animation_map_Armadillo_has_adult_and_baby_shards()
    {
        var adult = EntityCleanRoomAnimationMap.GetBindingsForParityBuilder("Armadillo")
        ...
        var baby = EntityCleanRoomAnimationMap.GetBindingsForParityBuilder("Armadillo")
