...
public sealed class ObfuscatedJarLiftReconciliationTests(ITestOutputHelper output)
{
    [Theory]
    [MemberData(nameof(GeometryIrStrictValidationTests.Phase8Cases), MemberType = typeof(GeometryIrStrictValidationTests))]
